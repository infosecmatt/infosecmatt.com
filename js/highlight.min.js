...
className:"meta",begin:/^\s*\.[\w_-]+/}]})})());hljs.registerLanguage("dos",(()=>{"use strict";return e=>{
...
className:"number",begin:"\\b\\d+",relevance:0},t]}}})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{const n={
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("swift",(()=>{"use strict";function e(e){
...
keyword:["if","then","else","elif","fi","for","while","in","do","done","case","esac","function","su","sudo","grep"],
literal:["true","false"],
built_in:'break cd continue eval exec exit export getopts hash pwd readonly return shift test times trap umask unset alias bind builtin caller command declare echo enable help let local logout mapfile printf read readarray source type typeset ulimit unalias set shopt autoload bg bindkey bye cap chdir clone comparguments compcall compctl compdescribe compfiles compgroups compquote comptags comptry compvalues dirs disable disown echotc echoti emulate fc fg float functions getcap getln history integer jobs kill limit log noglob popd print pushd pushln rehash sched setcap setopt stat suspend ttyctl unfunction unhash unlimit unsetopt vared wait whence where which zcompile zformat zftp zle zmodload zparseopts zprof zpty zregexparse zsocket zstyle ztcp strings netcat nc nmap gobuster hashcat ssh scp id msfvenom mysql john rm head whoami snap bash curl cat dir powershell chisel netstat msiexec certutil.exe cp wget mv hydra ls ln vi vim tcpdump chmod base64 smbclient dig awk crackmapexec smbmap'
...
className:"meta",begin:/^\s{0,3}[─\-┌└╼\<\>/~.\w\d\n[\]\\():-@]*[>%$#][ ]?/,starts:{
...
className:{1:"keyword",3:"title.class"}}])}}})());hljs.registerLanguage("awk",(()=>{"use strict";return e=>({name:"Awk",keywords:{
...
contains:[c]}]}}})());hljs.registerLanguage("vbscript",(()=>{"use strict";function e(e){
...
className:"variable.constant"},R,k,{match:/\$[(.]/}]}}})());hljs.registerLanguage("dockerfile",(()=>{"use strict";return e=>({
